...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu mt-4">
            ...
            <a href="manage_classes.php"><i class="fas fa-list"></i>manage Classes</a>
            <a href="manage_session.php"><i class="fas fa-list"></i>manage Session</a>
            <a href="manage_students.php"><i class="fas fa-list"></i>manage Students</a>
            <a href="manage_subject.php"><i class="fas fa-list"></i>manage Subject</a>
